...
BEGIN
    -- Selecciona los datos del certificado para un curso específico
    SELECT 
        c.id,
        c.name,
        c.hours,
...
BEGIN
    -- Cuenta el número de certificados que tiene un estudiante
...
-- Actualizamos algunos cursos existentes para tener datos de prueba
