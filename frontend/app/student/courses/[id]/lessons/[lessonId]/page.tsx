          ...
          <CardContent className="p-4">
            ...
            <div className="space-y-2">
              ...
              <Button variant="ghost" className="w-full justify-start" asChild>
                <Link href={`/student/courses/${params.id}/lessons/1`}>Lección 1: ¿Qué es el desarrollo web?</Link>
              </Button>
              <Button variant="ghost" className="w-full justify-start" asChild>
                <Link href={`/student/courses/${params.id}/lessons/2`}>Lección 2: Herramientas necesarias</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button variant="outline" asChild>
                  <Link href={`/student/courses/${params.id}/lessons/${Number(params.lessonId) - 1}`}>
